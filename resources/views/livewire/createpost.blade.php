        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div> <h1 class="font-bold text-center mb-5">Orders</h1> </div>
                    <div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input wire:model='size' type="text" class="shadow appearance-none border rounded w-full py-2 px-3">
                            @error('title') <h1 class="text-red-500">{{$message}}</h1>@enderror
                        </div>
                        <div class="mb-2">
                            <label for="block">Catatan</label>
                            <textarea wire:model='catatan' name="catatan" class="shadow appearance-none border rounded w-full py-2 px-3"></textarea>
                            @error('description') <h1 class="text-red-500">{{$message}}</h1>@enderror
                        </div>
                        <div class="mb-2">
                            <label for="block">No.Telp</label>
                            <input wire:model='no_telp' type="text" class="shadow appearance-none border rounded w-full py-2 px-3">
                            @error('title') <h1 class="text-red-500">{{$message}}</h1>@enderror
                        </div>
